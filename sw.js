const CORE_CACHE = 'balance-dojo-core-v2';
const DATA_CACHE = 'balance-dojo-data-v1';
const CORE = ['./', './index.html', './styles.css?v=2', './src/app.js?v=2', './src/core/bitboard.js', './src/core/session.js', './src/core/symmetry.js', './src/data/native-balanced-dag.js', './src/data/shard-repository.js', './src/storage/progress-store.js', './data/release-manifest.json'];
