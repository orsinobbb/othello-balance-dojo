...
題目採循序解鎖：預設從第 01 題開始，完成終局和局後以 `localStorage` 記錄成功時間、完成次數與步數，並解鎖下一題。已完成與已解鎖題目可自由選擇複習。

## 資料範圍

- 16 個 e20 起始盤面
- 20,211 個盤面節點、21,235 條關係
- 7,756 條平衡關係、12,995 條失敗關係、484 條 pass 關係
- 約 964 KiB 二進位資料，載入時驗證 SHA-256
